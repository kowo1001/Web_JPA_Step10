...
public class ProbonoProjectDAO {
	...
	//모든 프로보노 프로젝트 검색 
	public static ArrayList<ProbonoProject> getAllProbonoProjects() throws SQLException, NoResultException {
		EntityManager em = PublicCommon.getEntityManager();
		ArrayList<ProbonoProject> adto = (ArrayList<ProbonoProject>) em.createNativeQuery("select * from probono_project", ProbonoProject.class).getResultList();
		if(adto.size() != 0) {
			return adto;
		}
