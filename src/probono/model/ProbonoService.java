...
import probono.model.domain.ProbonoProject;
...
public class ProbonoService {
	...
	public static void notExistActivist(String activistId) throws NotExistException, SQLException{
		Activist activist = ActivistDAO.getActivist(activistId);
		if(activist == null){
			throw new NotExistException("검색하는 재능 기부자가 미 존재합니다.");
		}
	}
	public static boolean addActivist(String id, String name, String pw, String major) throws MessageException{
		boolean result = false;
		try{
			result = ActivistDAO.addActivist(id, name, pw, major);
	...
	public static Activist getActivist(String activistId) throws SQLException, NotExistException{
		Activist activist = ActivistDAO.getActivist(activistId);
		if(activist == null){
			throw new NotExistException("검색하는 재능 기부자가 미 존재합니다.");
		}
	...
	public static ArrayList<Activist> getAllActivists() throws SQLException{
...
//	}
	public static ArrayList<ProbonoProject> getAllProbonoProjects() throws SQLException,NotExistException {
		ArrayList<ProbonoProject> probonoProjectAll = ProbonoProjectDAO.getAllProbonoProjects();
		if(probonoProjectAll == null){
			throw new NotExistException("검색하는 재능기부 프로젝트가 미 존재합니다.");
		}
		return probonoProjectAll;
